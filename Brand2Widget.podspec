...
s.homepage     = "https://github.com/murali-git/Widgets"
s.license      = { :type => 'MIT' }
s.license      = { :type => "MIT", :file => "Widgets/License.txt" }
s.author       = { "murali-git" => "murali.reachme@gmail.com" }
s.platform     = :ios, "8.0"
s.source       = { :git => "https://github.com/murali-git/Widgets.git", :tag => s.version }
s.source_files = 'Widgets/Brands/Brand2/*.{h,m}'
end
